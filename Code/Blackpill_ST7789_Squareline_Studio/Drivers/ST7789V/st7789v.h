...
#define ST7789V_RST_PIN  GPIO_PIN_2
#define ST7789V_DC_PORT  GPIOA
#define ST7789V_DC_PIN   GPIO_PIN_4
...
//#define ST7789V_ROTATION 2
#define ST7789V_ROTATION 3              //Rotation has to be set in the st7789v.c file, not sure why
...
#define ST7789V_NOP     0x00   //Same
#define ST7789V_SWRESET 0x01   //Same
#define ST7789V_RDDID   0x04   //Same
#define ST7789V_RDDPM   0x0A
#define ST7789V_RDDMADCTL   0x0B

#define ST7789V_SLPIN   0x10  //Same
#define ST7789V_SLPOUT  0x11  //Same
#define ST7789V_PTLON   0x12  //Same
#define ST7789V_NORON   0x13  //Same

#define ST7789V_INVOFF  0x20  //Same
#define ST7789V_INVON   0x21  //Same
#define ST7789V_DISPOFF 0x28  //Same
#define ST7789V_DISPON  0x29  //Same
#define ST7789V_CASET   0x2A  //Same
#define ST7789V_RASET   0x2B  //Same
#define ST7789V_RAMWR   0x2C  //Same
#define ST7789V_RAMRD   0x2E  //Same

#define ST7789V_PTLAR   0x30  //Same
#define ST7789V_COLMOD  0x3A  //Same
#define ST7789V_MADCTL  0x36  //Same
